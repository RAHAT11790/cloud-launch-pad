    ...
    <div className={`fixed inset-0 z-[300] bg-background/[0.98] flex flex-col items-center ${isFullscreen ? '' : 'overflow-y-auto'}`} ref={containerRef}>
      ...
      <div className={`w-full ${isFullscreen ? 'h-full p-0' : 'max-w-full p-5'}`}>
        ...
        >
          ...
          {/* Settings panel */}
          {showSettings && (
            <div className="absolute bottom-16 right-3 player-glass rounded-xl p-2.5 z-20 w-[210px] max-w-[78vw] max-h-[230px] overflow-y-auto shadow-lg" onClick={(e) => e.stopPropagation()}>
