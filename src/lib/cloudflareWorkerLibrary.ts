...
export const CF_WORKER_LIBRARY: CfLibraryEntry[] = [
  entry("video-proxy",     "Video Proxy",     "⚡ v11 ZERO-WAIT RANGE STREAMING — MP4/MKV range requests stream immediately instead of waiting for a full 16MB proxy window, while Cloudflare still edge-caches cloned media responses + HLS segments. Fixes HTTP resume, seek, first-frame, and episode-switch latency.", videoProxySrc, [], { isNew: true, badgeText: "v11 · NEW", badgeTone: "amber" }),
