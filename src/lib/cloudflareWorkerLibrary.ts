...
export const CF_WORKER_LIBRARY: CfLibraryEntry[] = [
  entry("video-proxy",     "Video Proxy",     "⚡ v10 STREAM-FIRST EDGE CACHE — Cloudflare caches bounded MP4 range windows + HLS segments, while full MP4 requests stream instantly instead of buffering the whole movie. Fixes first-frame, resume, skip, and episode-switch latency.", videoProxySrc, [], { isNew: true, badgeText: "v10 · NEW", badgeTone: "amber" }),
