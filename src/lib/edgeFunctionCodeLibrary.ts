...
export const EDGE_FUNCTION_LIBRARY: EdgeFnLibraryEntry[] = [
  entry("video-proxy",    "Video Proxy",    "⚡ v10 STREAM-FIRST EDGE CACHE — range MP4 windows + HLS segments are cached, but full MP4 requests stream immediately so first frame, resume, skip, and episode switching do not wait for whole-file buffering. Redeploy and paste the URL into EGD Router → video-proxy.", videoProxySource, [], { isNew: true, badgeText: "v10 · NEW", badgeTone: "amber" }),
